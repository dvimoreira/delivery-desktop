...
const electronPosPrinter = require("@3ksy/electron-pos-printer");
...
async function createWindow() {
  ...
  ipcMain.handle("get-printers-list", async () => {
    if (isWindows) {
      ...
      return {0: "Sistema não compatível."}
    }
  });
  // END LIST PRINTERS
    ...
    let data = [
      {
        ...
        style: { fontWeight: "700", textAlign: "left", fontSize: "20px", marginBottom: "40px" }
      },
      {
        type: "text",
        // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
        value: "Cliente: " + result.cli_name,
        style: { fontWeight: "400", textAlign: "left", marginBottom: "5px", fontSize: "14px" }
      },
      {
        type: "text",
        // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
      ...
      },
      {
        ...
        style: { fontWeight: "400", textAlign: "left", borderBottom: "1px solid #000000", paddingBottom: "15px", marginBottom: "30px", fontSize: "14px" }
      },
      {
        type: "text",
        // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
    ...
    data.push(
      {
        ...
        style: { fontWeight: "600", textAlign: "left", borderBottom: "1px solid #000000", paddingBottom: "15px", marginBottom: "30px", fontSize: "14px" }
      },
      {
        type: "text",
        // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
