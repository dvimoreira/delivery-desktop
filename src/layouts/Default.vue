    ...
    <div id="layout-default">
        <div id="layout-default__navigation">
            <div id="layout-default__navigation__logo">
                <img :src="`https://demonstracao.menucardapio.digital/logos/${restaurant.logo}`">
            </div>
...
<script>
  ...
  import restaurantComposable from '../composables/restaurant'
  ...
  export default {
    ...
    methods: {
      async checkRestaurant () {
        const result = await restaurantComposable.checkOnline(this.restaurant.id)
        this.restaurantStatus = result.data.data
      },

      async onUpdate () {
        try {
          const result = await restaurantComposable.updateStatus({ restaurant_id: this.restaurant.id })
